                ...
                <a class="nav-link {{ (Request::is('static-analysis') ? 'active' : '') }}" href="{{ route('static.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1273.000000, -568.000000)" fill="#000000" fill-rule="nonzero">
                                    <g transform="translate(1273.000000, 568.000000)">
                                        <path class="color-background" d="M21,0 C9.4,0 0,9.4 0,21 C0,32.6 9.4,42 21,42 C32.6,42 42,32.6 42,21 C42,9.4 32.6,0 21,0 Z M16,29 L16,13 L30,21 L16,29 Z"></path>
                                    </g>
                                </g>
                            </g>
                        </svg>
                    </div>
                    <span class="nav-link-text ms-1">Analisis Video Statis</span>
                </a>
            </li>
